  ...
  return (
    <div className="sellers-group" key={user._id}>
        ...
        <div className="sellers-body">
            ...
            {existUser && sellerExists ? (<span key={user._id} onClick={() => handlerUnfollow(user)} className='unfollow'>Dejar de seguir</span>) : (<span key={user._id} onClick={handlerFollow} className='follow'>Seguir</span>)}
